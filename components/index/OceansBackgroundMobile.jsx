...
const draw = (p5) => {
  ...
  level = amplitude.getLevel() * 100 + 0.5;
...
const OceansBackgroundMobile = () => {
  ...
  const styles = {
    ...
    buttonText:
      "text-xl text-gray-700 p-4 sm:hover:text-gray-600 lg:text-2xl",
  };
      ...
      <div className="absolute bottom-10 w-full px-5">
        <div className="flex justify-between">
          <button className={styles.buttonText} onClick={togglePlay}>
            {soundLoading ? "Laddar" : isPlaying ? "Pause audio" : "Play audio"}
          </button>
          {/* <a
...
export default OceansBackgroundMobile;
